...
public class UserThreadLinkDao extends AbstractDao<UserThreadLink, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, UserThreadLink entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, UserThreadLink entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(UserThreadLink entity) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(UserThreadLink entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(UserThreadLink entity) {
